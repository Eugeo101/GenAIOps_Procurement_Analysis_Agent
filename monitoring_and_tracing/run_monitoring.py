...
PROMPTS_DIR = Path(__file__).parent / "src" / "procurement_analysis_agent" / "prompts"
TEST_PROMPTS_DIR = Path(__file__).parent / "src" / "procurement_analysis_agent" / "test_prompts"
...
def load_prompt(version: str) -> str:
    ...
    return (PROMPTS_DIR / f"system_instruction_v{version}.txt").read_text().strip()
